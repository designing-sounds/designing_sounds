...
class TestPriors(unittest.TestCase):
    ...
    def test_periodic_covariance_matrix(self):
        ...
        np.testing.assert_allclose(expected, PeriodicPrior(50).covariance_matrix(np.array([1, -3]), np.array([0.19, 5.12]), [442], [5], [0.06], [0], [0]), self.tolerance)
    ...
    def test_squared_exp_covariance_matrix(self):
        ...
        np.testing.assert_allclose(expected,
                                   SquaredExpPrior(50).covariance_matrix(np.array([1, -3]), np.array([0.19, 5.12]), [442],
